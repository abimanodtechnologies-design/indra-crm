...
export const completeFollowup = (id, b) => request('POST', `/followups/${id}/complete`, b);
...
export const sendProposal    = (id, body = {}) => one('proposal')('POST', `/proposals/${id}/send`, body);
...
export const fetchCustomerSuccessMessage = (id) => request('GET', `/customer-success/${id}/message-preview`);
...
export const sendPaymentReminder = (id) => request('POST', `/payment-reminders/${id}/send-reminder`);
...
export const fetchAssignees = () => request('GET', '/leads/assignees');
