...
export function EnquiryFields({formData, setFormData}) {
  ...
  const update = (key,value) => setFormData(previous => ({...previous,customFields:{...previous.customFields,enquiry:{...previous.customFields?.enquiry,[key]:value}}}));
